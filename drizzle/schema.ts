...
export const lenders = mysqlTable("lenders", {
  ...
  resiProductsUrl: text("resiProductsUrl"),
  btlProductsUrl: text("btlProductsUrl"),
  downloadMethod: text("downloadMethod"),
  resiDownloadUrl: text("resiDownloadUrl"),
  btlDownloadUrl: text("btlDownloadUrl"),
